              ...
              child: Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    TextButton(
                      onPressed: () => context.push('/student/home/timetable'),
              ...
              child: Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    TextButton(
                      onPressed: () =>
                          context.push('/student/home/assignments'),
                ...
                if (uid != null)
                  StreamBuilder<DocumentSnapshot>(
                    ...
                    builder: (context, snap) {
                      ...
                      return Text(
                        label.isEmpty ? 'Class not assigned yet' : label,
                        style: AppTextStyles.labelMedium.copyWith(
...
// OLD BUG: .orderBy('period') — 'period' field doesn't exist in timetable docs.
// FIX:     Remove orderBy from Firestore query; sort by 'startTime' in Dart.
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<DocumentSnapshot>(
      ...
      builder: (context, studentSnap) {
        final className =
            (studentSnap.data?.data() as Map<String, dynamic>?)?['class']
                as String?;
        if (className == null || className.isEmpty) {
          return Padding(
            padding: const EdgeInsets.symmetric(horizontal: 20),
            child: Text(
              'No class assigned yet — your schedule will appear once admin assigns you a class.',
              style: AppTextStyles.labelSmall.copyWith(
        ...
        // No .orderBy() on Firestore — avoids composite index requirement
        // and the broken 'period' field. Sorted by startTime in Dart below.
        return StreamBuilder<QuerySnapshot>(
          stream: FirebaseFirestore.instance
          ...
          builder: (context, snap) {
            ...
            // Sort by startTime string ("08:00", "09:30", …) in Dart
            docs = List.from(docs)
              ..sort((a, b) {
                final aT =
      ...
      child: Row(
        children: [
          ...
          Container(
            width: 2,
            height: 40,
            color: isNow ? Colors.white30 : AppColors.divider,
          ),
          const SizedBox(width: 16),
          Expanded(
            child: Column(
...
// ── Pending Assignments (FIXED) ───────────────────────────────────────────────
// OLD BUG: Inner StreamBuilder could fire before outer one resolved className,
//          returning empty results silently.
// FIX:     Added loading state guard; className must be non-empty before query.
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<DocumentSnapshot>(
      ...
      builder: (context, studentSnap) {
        ...
        // FIX: removed .orderBy('dueDate') — Firestore silently drops
        // documents when ANY result has a null dueDate with an orderBy.
        // We sort in Dart instead so no documents are lost.
        return StreamBuilder<QuerySnapshot>(
          stream: FirebaseFirestore.instance
          ...
          builder: (context, snap) {
            ...
            // Sort by dueDate in Dart (nulls go last)
          ...
          Column(
            ...
            children: [
              ...
              Text(
                dueDate,
                style: AppTextStyles.labelSmall.copyWith(
                  color: isUrgent ? Colors.redAccent : AppColors.textSecondary,
                  fontWeight: FontWeight.w600,
                ),
              ),
            ],
      ...
      onTap: (i) {
        switch (i) {
          case 0:
            ...
            break;
          case 1:
            context.go('/student/home/timetable');
            break;
          case 2:
            context.go('/student/home/assignments');
            break;
          case 3:
            context.go('/student/home/results');
            break;
          case 4:
            context.go('/student/home/profile');
            break;
        }
      },
      items: const [
