              ...
              builder: (context, snap) {
                ...
                return ListView.separated(
                  ...
                  itemBuilder: (_, i) => _NoticeCard(
                      notice: notices[i],
                      onDelete: () => _repo.delete(notices[i].id)),
                );
              },
            ),
          ),
                  ...
                  child: ElevatedButton(
                    onPressed: loading
                        ...
                        : () async {
                            ...
                            // 2. Notify all students, teachers, and parents
                            try {
                              await AppNotifications.onNoticePublished(
                                noticeTitle: title,
                                noticeBody: body,
                                category: category,
                              );
                            } catch (_) {
                              // Non-fatal — notice was saved successfully.
                            }
