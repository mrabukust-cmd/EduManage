        ...
        child: CustomScrollView(
          slivers: [
                    ...
                    return Column(
                      ...
                      children: [
                        Padding(
                          ...
                          child: Text('My Children', style: AppTextStyles.sectionTitle),
                        ),
                        const SizedBox(height: 12),
                        ...children.map((doc) {
                          final data = doc.data() as Map<String, dynamic>;
                          final studentId = data['studentId'] as String? ?? '';
                          return _ChildCard(studentId: studentId, docId: doc.id);
                        }),
                      ],
                    );
                  },
                ...
                child: GridView.count(
                  ...
                  children: [
                    ...
                    _QuickCard(
                      ...
                      onTap: () => context.push('/parent/home/timetable'),
                    ),
                  ],
                ),
              ),
            ...
            SliverToBoxAdapter(
              child: Padding(
                padding: const EdgeInsets.symmetric(horizontal: 20),
                child: Text('Latest Notices', style: AppTextStyles.sectionTitle),
              ),
            ),
        ...
        children: [
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text('Welcome,', style: AppTextStyles.labelMedium.copyWith(color: Colors.white70)),
...
// ── Child card (real data from students collection) ───────────────────────────
                ...
                children: [
                  ...
                  Expanded(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text(name, style: AppTextStyles.bodyMediumBold.copyWith(color: Colors.white)),
                        const SizedBox(height: 4),
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Text('Attendance', style: AppTextStyles.labelTiny.copyWith(color: Colors.white60)),
                    ],
                  ),
                ],
              ),
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Container(
        ...
        child: Column(
          children: [
            const Icon(Icons.family_restroom_rounded, size: 48, color: AppColors.textHint),
            const SizedBox(height: 12),
            Text('No child linked yet', style: AppTextStyles.bodyMediumBold),
            const SizedBox(height: 6),
            Text('Contact the school admin to link your child\'s account.',
      ...
      child: Container(
        ...
        child: Row(
          children: [
            ...
            Expanded(child: Text(label, style: AppTextStyles.labelSmall.copyWith(fontWeight: FontWeight.w600))),
          ],
        ),
      ),
    );
    ...
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snap) {
        ...
        if (docs.isEmpty) {
          return Padding(
            padding: const EdgeInsets.symmetric(horizontal: 20),
            child: Text('No notices yet.', style: AppTextStyles.labelSmall.copyWith(color: AppColors.textHint)),
          );
        }
        return Column(
          children: docs.map((doc) {
            ...
            final Color color;
            switch (category) {
              case 'Exam':   color = AppColors.primary; break;
              case 'Event':  color = AppColors.accent; break;
              case 'Finance': color = AppColors.warning; break;
              case 'Holiday': color = AppColors.success; break;
            ...
            return Container(
              ...
              child: Column(
                ...
                children: [
                  Row(
                    children: [
                      Container(
                        ...
                        child: Text(category, style: AppTextStyles.labelTiny.copyWith(color: color, fontWeight: FontWeight.w700)),
                      ),
                      const Spacer(),
                      Text(
                        data['createdAt'] != null
                            ? DateFormat('MMM d').format((data['createdAt'] as Timestamp).toDate())
                            : '',
                  ...
                  const SizedBox(height: 4),
                  Text(data['body'] ?? '', style: AppTextStyles.labelSmall, maxLines: 2, overflow: TextOverflow.ellipsis),
                ],
              ),
            );
          }).toList(),
...
class _ParentBottomNav extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BottomNavigationBar(
      ...
      onTap: (i) {
        switch (i) {
          case 0: context.go('/parent/home'); break;
          case 1: context.go('/parent/home/attendance'); break;
          case 2: context.go('/parent/home/results'); break;
          case 3: context.go('/parent/home/notices'); break;
          case 4: context.go('/parent/home/profile'); break;
        }
      },
      items: const [
